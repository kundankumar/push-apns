module Push
  class MessageApns < Push::Message
    ...
    serialize :properties, Hash #:accessors => [:alert, :badge, :sound, :expiry, :attributes_for_device, :content_available]
    ...
    #validates_numericality_of :expiry, :presence => true
    #validates_format_of :device, :with => /\A[a-z0-9]{64}\z/
    validate Push::Apns::BinaryNotificationValidator
